		...
		<section className="relative px-3 md:px-5 bg-[#f6f6f6]">
			<div className="max-w-7xl mx-auto flex flex-col gap-5 lg:flex-row lg:justify-between py-16 md:py-32">
				<div className="flex flex-col gap-7" style={{ width: '50%' }}>
					...
					<h1 className="text-4xl lg:text-6xl text-main-text">Key Sectors We Serve</h1>

					<div className="aspect-square relative">
						<img alt="Transport" src={currentImage} className="mix-blend-multiply" style={{ maxWidth: '90%' }} />
					</div>
				</div>
				...
				<div className="flex-1">
					<div className="lg:max-w-[100%] ml-auto flex flex-col">
						<div className="pb-10">
							<h3 className="text-body-text text-lg">Apollo Supply Chain serve a diverse range of key sectors:</h3>
						</div>
